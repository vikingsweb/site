...
<nav id="menu" class="navbar navbar-default navbar-fixed-top">
  <div class="container"> 
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand page-scroll" href="#home"><i class="fa fa-flag-checkered fa-flip-horizontal"></i> Vikings<strong></strong></a> </div>
    
    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#home" class="page-scroll">Início</a></li>
        <li><a href="#services-section" class="page-scroll">Serviços</a></li>
        <!--        
        ...
        <li><a href="#about-section" class="page-scroll">Sobre</a></li>
      </ul>
    </div>
    <!-- /.navbar-collapse --> 
  </div>
